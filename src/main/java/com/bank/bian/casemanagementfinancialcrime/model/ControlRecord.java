package com.bank.bian.casemanagementfinancialcrime.model;
...
/**
 * The BIAN control record for this service domain: "Financial Crime Case Management Plan".
 *
 ...
 * to its asset type (Financial Crime Case). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Financial Crime Case Management Plan";
